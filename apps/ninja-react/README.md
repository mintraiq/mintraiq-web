...
- **Output:** `mintraiq/react-embed/ninja-ui.js` (loaded as `type="module"`). Host pages set `<meta name="mintraiq-samples-base" content="…">` so fetches resolve to `docs/samples/`.
